...
genre_choices = (('ComputerScience', 'Computer Science'),
                ('Entertainment', 'Entertainment'),
                ('PureScience', 'Pure Science'),
)

lang_choices = (('Eng', 'English'),
                ('Fre', 'French'),
)
...
class Language(models.Model):
    name = models.CharField(max_length=20, choices=lang_choices)
...
class Student(models.Model):
    ...
    branch = models.CharField(max_length=50, help_text="Department of Study")
